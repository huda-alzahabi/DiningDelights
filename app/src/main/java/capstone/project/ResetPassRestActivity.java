...
public class ResetPassRestActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reset_pass_rest);
    }
    ...
    public void onClickReset(View view) {
        ...
        if (!(email.equals("") || pass.equals("") || confirm.equals(""))) {
            try {
                ...
                Cursor cursor = db.query("KITCHENS", new String[]{"EMAIL"}, "EMAIL=?", new String[]{email.toLowerCase()}, null, null, null);
